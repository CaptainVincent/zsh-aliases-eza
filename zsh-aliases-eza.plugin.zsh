...
alias la='eza -lbhHigUmuSa --time-style=long-iso --git --color-scale size'  # all list
alias lx='eza -lbhHigUmuSa@ --time-style=long-iso --git --color-scale size' # all + extended list
